  ...
  meta: [
    {
      name: "description",
      content:
        "Ready to hack together something amazing? Contact XMTRXI for IoT, web development, robotics, and system design projects. We respond within 24 hours.",
    },
  ],
});
...
const submitForm = async () => {
  ...
  try {
    ...
    submitMessage.value =
      "SUCCESS: Message transmitted successfully! We'll be in touch within 24 hours.";
  ...
  <div class="min-h-screen pt-20 bg-black overflow-hidden">
      ...
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h1 class="text-6xl md:text-8xl font-black mb-6 graffiti-font">
            ...
            <span
              class="block bg-gradient-to-r from-green-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent cyber-glow"
            >
              .US()
            </span>
          </h1>
          <p class="text-xl text-gray-300 max-w-3xl mx-auto code-font">
            <span class="text-green-400">//</span> Ready to hack together
            something amazing?<br />
            <span class="text-cyan-400">const</span> project = await
            <span class="text-purple-400">startCollaboration()</span>;
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span class="ml-4 code-font text-sm text-gray-400"
                >~/contact/new_project.form</span
              >
            </div>
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div data-stagger>
                  <label
                    for="firstName"
                    class="block text-sm font-medium text-cyan-300 mb-2 code-font"
                  >
              ...
              <div data-stagger>
                ...
                <Select v-model="form.budget">
                  <SelectTrigger
                    class="bg-black/50 border-gray-600 focus:border-cyan-500 text-white code-font"
                  >
                    <SelectValue
                      placeholder="SELECT budget_range FROM options"
                    />
                  </SelectTrigger>
                  <SelectContent class="bg-slate-800 border-gray-600">
                    <SelectItem
                      value="under-5k"
                      class="text-white hover:bg-slate-700 code-font"
                      >< $5,000 // Startup</SelectItem
                    >
                    <SelectItem
                      value="5k-15k"
                      class="text-white hover:bg-slate-700 code-font"
                      >$5,000 - $15,000 // Growth</SelectItem
                    >
                    <SelectItem
                      value="15k-50k"
                      class="text-white hover:bg-slate-700 code-font"
                      >$15,000 - $50,000 // Scale</SelectItem
                    >
                    <SelectItem
                      value="50k-plus"
                      class="text-white hover:bg-slate-700 code-font"
                      >$50,000+ // Enterprise</SelectItem
                    >
                  </SelectContent>
                </Select>
              </div>
              ...
              <div data-stagger>
                ...
                <div class="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    />
                    <span
                      class="ml-2 text-sm text-gray-300 group-hover:text-cyan-300 transition-colors code-font"
                      >{{ service }}</span
                    >
                  </label>
                </div>
   ...
   Any specific tech requirements? */"
          ...
          <div class="space-y-8" data-animate="fade-left">
            <!-- Company Info -->
            <div
              class="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/30"
              data-stagger
            >
              <h3 class="text-xl font-bold mb-6 text-white graffiti-font">
                CONTACT_INFO.json
              </h3>
              ...
              <div class="space-y-6">
                <div class="flex items-start space-x-4 group">
                  <div
                    class="w-12 h-12 bg-gradient-to-br from-green-500 to-cyan-500 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300"
                  >
                    <Icon name="lucide:mail" class="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h4 class="font-semibold text-white mb-1 code-font">
                      email: "contact@xmtrxi.com"
                    </h4>
                    <p class="text-gray-300 code-font">
                      response_time: "< 24 hours"
                    </p>
                    <p class="text-sm text-gray-400 code-font">
                      status: "always_monitoring"
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-start space-x-4 group">
                  <div
                    class="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300"
                  >
                ...
                <div class="flex items-start space-x-4 group">
                  <div
                    class="w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300"
                  >
                  ...
                  <div>
                    ...
                    <p class="text-gray-300 code-font">
                      timezone: "your_preference"
                    </p>
                    <p class="text-sm text-gray-400 code-font">
                      availability: "24/7_async"
                    </p>
                  </div>
                </div>
              </div>
            ...
            <!-- Quick Stats -->
            <div
              class="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-2xl p-8 border border-cyan-500/30"
              data-stagger
            >
              <h3 class="text-xl font-bold mb-6 text-white graffiti-font">
                QUICK_STATS.db
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="text-center p-4 bg-black/30 rounded-lg">
                  ...
                  <div class="text-xs text-gray-400 code-font">
                    projects_deployed
                  </div>
                </div>
                <div class="text-center p-4 bg-black/30 rounded-lg">
            ...
            <!-- Tech Stack Preview -->
            <div
              class="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-2xl p-8 border border-green-500/30"
              data-stagger
            >
              <h3 class="text-xl font-bold mb-6 text-white graffiti-font">
                TECH_STACK.yml
