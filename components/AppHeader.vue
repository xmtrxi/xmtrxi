    ...
    <nav class="container mx-auto px-4 py-4 relative z-10">
      <div class="flex items-center justify-between">
        ...
        <NuxtLink 
          ...
          @mouseenter="playGlitchEffect"
        >
          <div class="relative">
            <!-- Main Logo -->
            <h1 class="text-3xl font-black graffiti-font tracking-wider transition-all duration-300 group-hover:scale-110">
              <span class="bg-gradient-to-r from-green-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent cyber-glow">
                {'<'}
              </span>
              <span class="text-white group-hover:text-cyan-300 transition-colors">
                XMTRXI
              </span>
              <span class="bg-gradient-to-r from-purple-400 via-cyan-400 to-green-400 bg-clip-text text-transparent cyber-glow">
                {'/>'}
              </span>
            </h1>
            ...
            <!-- Subtitle -->
            <p class="text-xs code-font text-gray-400 group-hover:text-cyan-400 transition-colors mt-1">
        ...
        <div class="hidden md:flex items-center space-x-8">
          <NuxtLink 
            ...
            :key="item.name"
            :to="item.href" 
            class="group relative text-gray-300 hover:text-cyan-300 transition-all duration-300 code-font font-semibold"
          ...
          >
            ...
            <!-- Hover Effect -->
            <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-green-400 via-cyan-400 to-purple-400 group-hover:w-full transition-all duration-500"></span>
            
            <!-- Glow Effect -->
            <div class="absolute inset-0 bg-cyan-400/20 rounded blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"></div>
          </NuxtLink>
        </div>
        ...
        <div class="hidden md:block">
          ...
          >
            ...
            <div class="relative z-10 flex items-center">
              <Icon name="lucide:zap" class="w-4 h-4 mr-2 group-hover:rotate-12 transition-transform duration-300" />
              INIT_PROJECT()
            </div>
            ...
            <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <div class="absolute top-1/4 left-0 w-full h-px bg-white/50 animate-pulse"></div>
              <div class="absolute bottom-1/4 left-0 w-full h-px bg-white/50 animate-pulse animation-delay-200"></div>
            </div>
          </Button>
        </div>
      ...
      >
        <div class="flex flex-col space-y-4 pt-4 px-4">
          ...
          >
            <span class="text-green-400">//</span> {{ item.name.toLowerCase() }}
            <div class="w-0 h-0.5 bg-gradient-to-r from-green-400 to-cyan-400 group-hover:w-full transition-all duration-300 mt-1"></div>
          </NuxtLink>
