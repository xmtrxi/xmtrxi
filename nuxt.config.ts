...
export default defineNuxtConfig({
  ...
  site: {
    ...
    description: process.env.NUXT_PUBLIC_SITE_DESCRIPTION || 'Open Source • IoT • Web Apps • System Design • CI/CD • Robotics',
    defaultLocale: 'en',
  },
  ...
  app: {
    head: {
      ...
      meta: [
        { name: 'description', content: 'Premium digital agency crafting extraordinary web experiences, mobile apps, and digital solutions that drive business growth and user engagement.' },
        { name: 'keywords', content: 'web development, mobile apps, UI/UX design, digital agency, Nuxt.js, Vue.js, React, digital transformation, e-commerce, enterprise solutions' },
      ...
      script: [
        {
          ...
          children: JSON.stringify({
            ...
            '@type': 'Organization',
            name: 'XMTRXI',
            description: 'Premium digital agency crafting extraordinary web experiences and digital solutions.',
