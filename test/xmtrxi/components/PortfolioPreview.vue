<template>
  <section class="py-32 bg-gradient-to-b from-slate-900 to-black relative overflow-hidden">
    <!-- Matrix Background -->
    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="text-center mb-20">
        ...
        <p class="text-xl text-gray-300 max-w-3xl mx-auto code-font">
          <span class="text-green-400">const</span> projects = await <span class="text-cyan-400">getAwesomeWork()</span>.<span class="text-purple-400">filter</span>(p => p.isEpic);
        </p>
      </div>
        ...
        >
            ...
            >
              ...
              >
                <div class="text-center p-6">
                  <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-green-500 to-cyan-500 rounded-2xl flex items-center justify-center animate-pulse">
                    <Icon name="lucide:monitor" class="w-8 h-8 text-white" />
                  </div>
                  <p class="text-green-400 font-mono text-sm mb-2">// Loading website preview...</p>
                  ...
                  <p class="text-cyan-300 text-xs code-font">Booting: {{ project.tech.join(' + ') }}</p>
                </div>
              </div>
              ...
              >
                ...
                <div class="bg-gray-800 px-4 py-2 flex items-center space-x-2 border-b border-gray-700">
                  ...
                  <div class="flex-1 bg-gray-700 rounded px-3 py-1 ml-4">
                    <p class="text-xs text-gray-300 code-font">{{ project.url }}</p>
                  </div>
                  <Icon name="lucide:external-link" class="w-4 h-4 text-gray-400" />
                </div>
                
                <!-- Website Content Mockup -->
                <div class="h-48 bg-gradient-to-br" :class="project.gradient + ' relative overflow-hidden'">
                  ...
                  <div class="absolute inset-0 p-4 text-white">
                    ...
                    <div v-else-if="project.type === 'dashboard'" class="space-y-2">
                      <!-- Dashboard Layout -->
                      <div class="flex space-x-2">
          ...
          <div class="p-6">
            <div class="flex items-center justify-between mb-3">
              <h3 class="text-xl font-bold text-white group-hover:text-cyan-300 transition-colors graffiti-font">
                {{ project.title }}
              </h3>
              <div class="flex space-x-2">
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
              <div class="text-center">
                <div class="text-lg font-bold text-green-400">{{ project.stats.commits }}</div>
                <div class="text-xs text-gray-400">commits</div>
              </div>
              <div class="text-center">
                <div class="text-lg font-bold text-cyan-400">{{ project.stats.lines }}</div>
                <div class="text-xs text-gray-400">lines</div>
              </div>
              <div class="text-center">
                <div class="text-lg font-bold text-purple-400">{{ project.stats.stars }}</div>
          ...
          >
            <div class="absolute inset-0 bg-gradient-to-r from-transparent via-cyan-500/20 to-transparent transform -skew-x-12 animate-pulse"></div>
          </div>
        </div>
      </div>
      ...
      <div class="text-center mt-16">
        <NuxtLink to="/portfolio">
          <Button size="lg" class="bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 graffiti-font text-lg px-8 py-4">
